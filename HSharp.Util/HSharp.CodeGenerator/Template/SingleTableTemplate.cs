...
namespace HSharp.CodeGenerator.Template
{
    public class SingleTableTemplate
    {
        ...
        public BaseConfigModel GetBaseConfig(string path, string userName, string tableName, string tableDescription, List<string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputBusiness = Path.Combine(path, "HSharp.Business");
            baseConfigModel.OutputConfig.OutputWeb = Path.Combine(path, "HSharp.Web", "HSharp.Admin.Web");
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using HSharp.Util;");
            sb.AppendLine();

            sb.AppendLine("namespace HSharp.Entity." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildEntityParam(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("namespace HSharp.Model.Param." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using HSharp.Util;");
            sb.AppendLine("using HSharp.Util.Extension;");
            sb.AppendLine("using HSharp.Util.Model;");
            sb.AppendLine("using HSharp.Data;");
            sb.AppendLine("using HSharp.Data.Repository;");
            sb.AppendLine("using HSharp.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using HSharp.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");

            sb.AppendLine();

            sb.AppendLine("namespace HSharp.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildBusiness(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using HSharp.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using HSharp.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using HSharp.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace HSharp.Business." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildController(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using HSharp.Util;");
            sb.AppendLine("using HSharp.Util.Model;");
            sb.AppendLine("using HSharp.Entity;");
            sb.AppendLine("using HSharp.Model;");
            sb.AppendLine("using HSharp.Admin.Web.Controllers;");
            sb.AppendLine("using HSharp.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using HSharp.Business." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using HSharp.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace HSharp.Admin.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!string.IsNullOrEmpty(param["CodeEntity"].ParseToString()))
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "HSharp.Entity", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityName + ".cs");
            ...
            if (!param["CodeEntityParam"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "HSharp.Model", "Param", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityParamName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeService"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "HSharp.Service", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.ServiceName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeBusiness"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "HSharp.Business", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.BusinessName + ".cs");
                if (!File.Exists(codePath))
                {
