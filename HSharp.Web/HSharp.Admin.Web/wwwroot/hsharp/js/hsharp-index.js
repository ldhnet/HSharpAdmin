...
$(function () {
    ...
    $('.menuItem').on('click', function menuItem() {
        ...
        $('.menuTab').each(function () {
            if ($(this).data('id') == dataUrl) {
                if (!$(this).hasClass('active')) {
                    ...
                    scrollToTab(this);
                    // 显示tab对应的内容区
                    $('.mainContent .HSharp_iframe').each(function () {
                        if ($(this).data('id') == dataUrl) {
                            $(this).show().siblings('.HSharp_iframe').hide();
                            return false;
                        }
                    });
                }
        ...
        if (addMenuTab) {
            ...
            // 添加选项卡对应的iframe
            var ifrmaeStr = '<iframe class="HSharp_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
            $('.mainContent').find('iframe.HSharp_iframe').hide().parents('.mainContent').append(ifrmaeStr);
    ...
    $('.tabCloseOther').on('click', function closeOtherTabs() {
        $('.page-tabs-content').children("[data-id]").not(":first").not(".active").each(function () {
            $('.HSharp_iframe[data-id="' + $(this).data('id') + '"]').remove();
            $(this).remove();
        });
    ...
    function refreshTab() {
        ...
        var target = $('.HSharp_iframe[data-id="' + currentId + '"]');
    ...
    $('.tabCloseAll').on('click', function () {
        ...
        $('.page-tabs-content').children("[data-id]:first").each(function () {
            $('.HSharp_iframe[data-id="' + $(this).data('id') + '"]').show();
